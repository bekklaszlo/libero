/*===========================================================================*
 *                                                                           *
 *  lrlibr.c    Private LR library functions                                 *
 *                                                                           *
...
#include "prelude.h"                    /*  Public header file               */
#include "lrpriv.h"                     /*  Private header file              */
...
char *TrueName (char *name)
{
    ...
    capital  = !plain;                  /*  Start with capital unless plain  */
    fmtlen   = 0;
